...
const Buttons = ({handleClick}) => {
    ...
    return (
        ...
        <div id = "main-div"  role="toolbar">
        <button onClick={(e) => {handleClick(e)}} name = "clear" id = "clear" className="btn btn-danger">AC</button>
        <button onClick={(e) => {handleClick(e)}} name = "/" id = "divide" className="btn btn-secondary">/</button>
        <button onClick={(e) => {handleClick(e)}} name = "*" id = "multiply" className="btn btn-secondary">X</button>
        ...
        <button onClick={(e) => {handleClick(e)}} name = "=" id = "equals" className="btn btn-info">=</button>
